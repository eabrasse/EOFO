...
datafn = home+'data/h126wb_2015_85dd.p'
...
dd85_ma = ma.masked_where(~(goa_mask),D['dd85'][:])
...
p=ax0.pcolormesh(lon,lat,dd85_ma,shading='nearest',cmap=cmo.cm.thermal_r,vmin=0,vmax=220)
...
cbaxes.set_ylabel('Year day')
ax0.set_xlabel('Longitude')
ax0.set_xlim(195,225)
ax0.set_ylim(54,62)
ax0.set_ylabel('Latitude')
efun.dar(ax0)
ax0.text(0.9,.1,'85 degree day of 2015',transform=ax0.transAxes,fontsize=12,zorder=600,va='bottom',ha='right')
