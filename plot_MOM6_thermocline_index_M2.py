...
data_fn = home+'data/MOM6-NEP_EBSmean_thermocline_JulAugSep_1993-2019.csv'
...
if Month:
    ...
    ax1.plot(yearsmod,thermocline_year_avg,marker='o',linestyle='dashed',markersize=8,lw=1.5,color='m',mfc='m')
    ax1.plot(yearsM2,-summer_mld_year_avg,marker='o',linestyle='solid',markersize=8,lw=1.5,color='k',mfc='k')
    ax1.text(0.95,0.4,'MOM6',transform=ax1.transAxes,color='m',ha='right')
    ax1.text(0.95,0.5,'M2',transform=ax1.transAxes,color='k',ha='right')
    ax1.text(0.1,0.9,'Jul-Aug-Sep average, EBS mean thermocline depth',transform=ax1.transAxes)
